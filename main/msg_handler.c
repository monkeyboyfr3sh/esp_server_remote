...
esp_err_t msg_handler(audio_event_iface_msg_t msg)
{
    ...
    //         // Set to wakeup on pattern
    //         display_service_set_pattern((void *)led_periph, DISPLAY_PATTERN_BT_DISCONNECTED, mode);
    //     }
    //     /* Bluetooth is connected */
    //     else if (msg.cmd == PERIPH_BLUETOOTH_CONNECTED) {
    //         ESP_LOGI(TAG, "[ * ] Bluetooth connected");
    //         // Set to wakeup on pattern
    //         display_service_set_pattern((void *)led_periph, DISPLAY_PATTERN_BT_CONNECTED, mode);
    //     }
    // }
